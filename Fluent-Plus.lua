...
local Themes = {
  ...
  Orange = { ----------[[ Orange ]]----------
		...
		AcrylicMain = Color3.fromRGB(30, 20, 0),
		AcrylicBorder = Color3.fromRGB(70, 40, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 30, 0), Color3.fromRGB(25, 15, 0)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(120, 60, 0),
		Tab = Color3.fromRGB(180, 90, 0),
		Element = Color3.fromRGB(200, 100, 0),
		ElementBorder = Color3.fromRGB(90, 45, 0),
		InElementBorder = Color3.fromRGB(150, 75, 0),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(200, 120, 0),
		ToggleToggled = Color3.fromRGB(255, 150, 0),
		SliderRail = Color3.fromRGB(180, 100, 0),
		DropdownFrame = Color3.fromRGB(230, 120, 0),
		DropdownHolder = Color3.fromRGB(40, 25, 0),
		DropdownBorder = Color3.fromRGB(80, 40, 0),
		DropdownOption = Color3.fromRGB(200, 100, 0),
		Keybind = Color3.fromRGB(200, 100, 0),
		Input = Color3.fromRGB(255, 160, 60),
		InputFocused = Color3.fromRGB(35, 20, 0),
		InputIndicator = Color3.fromRGB(255, 180, 100),
		Dialog = Color3.fromRGB(45, 25, 0),
		DialogHolder = Color3.fromRGB(35, 20, 0),
		DialogHolderLine = Color3.fromRGB(50, 25, 0),
		DialogButton = Color3.fromRGB(70, 35, 0),
		DialogButtonBorder = Color3.fromRGB(120, 60, 0),
		DialogBorder = Color3.fromRGB(90, 45, 0),
		DialogInput = Color3.fromRGB(70, 35, 0),
		DialogInputLine = Color3.fromRGB(255, 150, 0),
		Text = Color3.fromRGB(255, 230, 200),
		SubText = Color3.fromRGB(200, 150, 100),
		Hover = Color3.fromRGB(255, 170, 60),
		HoverChange = 0.07,
	}
}
